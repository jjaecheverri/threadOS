...
// Drifty — Perplexity Content Script

let lastTurn = '';

const getUser = () => {
  const els = document.querySelectorAll('[class*="query"], .break-words');
...
function startCapture() {
  new MutationObserver(() => {
    ...
    window.__drifty_t = setTimeout(() => {
      ...
      lastTurn = finalKey;
      captureSession({ model: 'Perplexity', prompt: p, response: finalR });
    }, 2000);
